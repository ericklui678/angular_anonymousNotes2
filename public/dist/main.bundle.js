...
// module
exports.push([module.i, ".noteList{\n  border: 3px solid black;\n}\n.child{\n  border: 3px solid blue;\n}", ""]);
...
module.exports = "<h1>Anonymous Notes</h1>\n<div class='noteList'>\n  <div class='child'>\n    <app-form (passNote)='dataFromChild($event)'></app-form>\n  </div>\n  <p>PARENT HERE</p>\n  <div *ngFor='let note of notes'>\n    {{ note.note }} Note at: {{ note.createdAt | date: 'medium' }}\n  </div>\n</div>"
...
AppComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__http_service__["a" /* ApiService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__http_service__["a" /* ApiService */]) === "function" && _a || Object])
], AppComponent);
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_2__http_service__["a" /* ApiService */]],
...
module.exports = "<form #regForm='ngForm' (submit)='onSubmit(note_obj, regForm)'>\n  Note: <input type=\"text\" name=\"note\"\n  [(ngModel)]='note_obj.note'\n  #note='ngModel'\n  required\n  minlength='3'\n  maxlength='100'>\n  <input [disabled]='!regForm.valid' type=\"submit\" value=\"Add Note\">\n</form>\n\n<div *ngFor='let note of notes'>\n  {{ note.note }}\n</div>"
...
var FormComponent = (function () {
    function FormComponent(_http) {
        this._http = _http;
        this.passNote = new __WEBPACK_IMPORTED_MODULE_1__angular_core__["F" /* EventEmitter */]();
        this.note_obj = new __WEBPACK_IMPORTED_MODULE_2__note__["a" /* Note */]();
        this.notes = [];
    }
    FormComponent.prototype.onSubmit = function (note, form) {
        var _this = this;
...
], FormComponent.prototype, "passNote", void 0);
...
var ApiService = (function () {
    ...
    ApiService.prototype.create = function (quote) {
        console.log('SERVICE DATA PARAM', quote);
        return this._http.post('/new', quote)
            .map(function (data) { return data.json(); })
            .toPromise();
    };
    ApiService.prototype.retrieve = function () {
